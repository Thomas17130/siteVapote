...
if ($msgError) {
    ...
    $_SESSION['email'] = $db->lastInsertEmail();
    $_SESSION['firstname'] = $db->lastInsertFirstname();
    $_SESSION['lastname'] = $db->lastInsertLastname();
    $_SESSION['nickname'] = $db->lastInsertNickname();
    $_SESSION['img'] = $db->lastInsertImg();
